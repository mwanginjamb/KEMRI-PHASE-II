...
class PeriodicInductionController extends Controller
{
        ...
        foreach ($records as $quali) {
            ...
            if ($quali->Action_ID == \Yii::$app->user->identity->{'Employee No_'} || $quali->Employee_No == \Yii::$app->user->identity->{'Employee No_'}) {
                ...
                $result['data'][] = [
                    ...
                    'Status' => !empty($quali->Overall_Status) ? $quali->Overall_Status : '',
    ...
    public function actionSendForApproval($No)
    {
        ...
        $data = [
            'inductionNo' => $No,
            'urLToSend' => Yii::$app->urlManager->createAbsoluteUrl(['periodic-induction/view', 'No' => $No]),
    ...
    public function actionSendToEmployee()
    {
        ...
        $data = [
            'inductionNo' => $No,
            'urLToSend' => Yii::$app->urlManager->createAbsoluteUrl(['periodic-induction/view', 'Key' => $Key]),
        ];
