...
use frontend\models\RequisitionQuestions;
use yii\web\Response;
use kartik\mpdf\Pdf;


class RequisitionQuestionController extends Controller
{
    ...
    public function actionCreate($No){
       ...
       $model = new RequisitionQuestions();
        ...
        if(Yii::$app->request->post() && Yii::$app->navhelper->loadpost(Yii::$app->request->post()['RequisitionQuestions'],$model) ){
