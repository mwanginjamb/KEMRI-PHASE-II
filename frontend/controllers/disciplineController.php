...
class DisciplineController extends Controller
{
    public function behaviors()
    {
        return [
            'access' => [
                ...
                'only' => ['logout', 'signup', 'index', 'list', 'create', 'update', 'delete', 'list', 'list-closed'],
                'rules' => [
                    [
                        'actions' => ['signup'],
                        'allow' => true,
                    ...
                    [
                        'actions' => ['logout', 'index', 'list', 'create', 'update', 'delete', 'list', 'list-closed'],
                        'allow' => true,
                        'roles' => ['@'],
                    ],
                ],
    ...
    {
        $service = Yii::$app->params['ServiceName']['ClosedCaseList'];
