...
class RecruitmentController extends Controller
{
    ...
    public function actionGetinternalvacancies()
    {
        ...
        $filter = [
            'Requisition_Type' => 'Internal | Both',
        ];
        $requisitions = \Yii::$app->navhelper->getData($service, $filter);
        // echo '<pre>';
        // print_r($requisitions);
    ...
    public function getGetShortListCriteria()
    {
        $service = Yii::$app->params['ServiceName']['ShortlistPreference'];

        $res = [];
        $PostalCodes = \Yii::$app->navhelper->getData($service);
        foreach ($PostalCodes as $PostalCode) {
            if (!empty($PostalCode->Interview_Preference))
                $res[] = [
                    'Code' => $PostalCode->Interview_Preference,
                    'Name' => $PostalCode->Interview_Preference
                ];
        }
    ...
    public function actionMyShortLisitngCommittees()
    ...
    public function actionGetMyShortListingCommittees()
    { //shortlist-committee.php
