...
$this->title = 'HRMIS - Long Term  Performance Appraisal Status: Head of Section';
    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">Long Term Performance Appraisals Status: Head of Section List</h3>
            </div>
            <div class="card-body">
        ...
        var absolute = $('input[name=absolute]').val();
         ...
         $.fn.dataTable.ext.errMode = 'throw';
          ...
          $('#appraisal').DataTable({
            ...
            //serverSide: true,  
            ajax: absolute+'appraisal/long-term-status-list-hs',
            paging: true,
             columns: [
