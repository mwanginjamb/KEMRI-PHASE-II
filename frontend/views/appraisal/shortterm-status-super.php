...
$this->title = 'HRMIS - Short Term Appraisals List: Supervisor';
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Short Term Appraisal Status: Supervisor List</h3>
                </div>
                <div class="card-body">
        ...
        var absolute = $('input[name=absolute]').val();
         ...
         $.fn.dataTable.ext.errMode = 'throw';
          ...
          $('#appraisal').DataTable({
            ...
            //serverSide: true,  
            ajax: absolute+'appraisal/short-term-status-super',
            paging: true,
             columns: [
