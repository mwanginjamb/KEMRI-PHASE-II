...
$this->params['breadcrumbs'][] = ['label' => 'Pending Training List', 'url' => ['index']];
    ...
    <div class="col-md-12">
        <div class="card card-info">
            <div class="card-header">
                <h3 class="card-title">Training Applications Pending Approval List</h3>
            </div>
            <div class="card-body">
    ...
    $(function(){
        ...
        const url = $('#url').val();
          ...
          $('#table').DataTable({
            ...
            //serverSide: true,  
            ajax: url+'training-pending/list',
            paging: true,
            columns: [
