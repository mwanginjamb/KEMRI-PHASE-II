...
$this->params['breadcrumbs'][] = ['label' => 'Induction Status', 'url' => ['clearance-status']];
    ...
    <div class="col-md-12">
        <div class="card card-info">
            <div class="card-header">
                <h3 class="card-title">Induction Status</h3>
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr class="<?= $cleared ?>">
                                    ...
                                    <td><?= !empty($status->HOD_No) ? $status->HOD_No : '' ?></td>
                                    <td><?= !empty($status->HOD_Name) ? $status->HOD_Name : '' ?></td>
                                    <td><?= !empty($status->Department) ? $status->Department : '' ?></td>
                                    <td><?= !empty($status->Sequence) ? $status->Sequence : '' ?></td>
                                    <td><?= !empty($status->Induction_No) ? $status->Induction_No : '' ?></td>
