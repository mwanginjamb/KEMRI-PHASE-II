        ...
        <div class="card">
            <div class="card-header">
                <div class="breadcrumbb flat">
                    <a href="<?=  Yii::$app->recruitment->absoluteUrl() .'interviews/applicant-details?ProfileID='.$model->No.'&ComitteID='.$model->CommiteeID ?>" <?= Yii::$app->recruitment->currentaction('interviews',['applicant-details', 'update'])?'class="active"': '' ?>>Personal Info</a>
                    <a href="<?=  Yii::$app->recruitment->absoluteUrl() .'interviews/qualification/?ProfileID='.$model->No .'&ComitteID='.$model->CommiteeID ?>" <?= Yii::$app->recruitment->currentaction('interviews','qualification')?'class="active"': '' ?>>Academic Qualifications</a>
                    <a href="<?=  Yii::$app->recruitment->absoluteUrl() .'interviews/proffesional-qualifications?ProfileID='.$model->No .'&ComitteID='.$model->CommiteeID ?>" <?= Yii::$app->recruitment->currentaction('interviews','proffesional-qualifications')?'class="active"': '' ?>>Proffesonal Certifications</a>
                    <a href="<?=  Yii::$app->recruitment->absoluteUrl() .'interviews/work-experience?ProfileID='.$model->No . '&ComitteID='.$model->CommiteeID ?>" <?= Yii::$app->recruitment->currentaction('interviews','work-experience')?'class="active"': '' ?>>Employment record</a>
