    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header">
                ...
                <?= Html::a(
                    '<i class="fas fa-backward"></i> Go Back To List',
                    ['applicants', 'ComiteeID' => $model->CommiteeID],
                    [
                ...
                <?= Html::a('<i class="fas fa-times"></i> Reject', ['reject-candidate', 'ProfileID' => urlencode($model->ApplicationID), 'ComitteID' => urlencode($model->CommiteeID)], [
                    'class' => 'btn btn-app bg-warning rejectey RejectCandidateButton',
                    ...
                    <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                            ...
                            <div class="modal-header">
                                ...
                                <h4 class="modal-title" id="myModalLabel" style="position: absolute">Shortlisting Details</h4>
                            </div>
